                        ...
                        <div class="page-header">
                            <div class="page-title">
                               <h2>Dữ Liệu Đấu Thầu</h2>
                                ...
                                <h4>Tổng dữ liệu: <?php 
                               $sqllimit = "SELECT COUNT(*) AS limit FROM TBMT WHERE LinhVuc = (SELECT linhVucName FROM linhvuc WHERE linhVucID = (SELECT linhVucID FROM accounts WHERE username = '".$user."'));";
                        ...
                        <table class="tbl">
                            ...
                            <tbody>
                                ...
                                if (sqlsrv_has_rows($sqlCount) == true) {
                                    ...
                                    $sql = "SELECT * FROM TBMT where linhvuc = (SELECT linhVucName FROM linhvuc WHERE linhVucID = (SELECT linhVucID FROM accounts WHERE username = '".$user."')) order by NgayDangTai DESC OFFSET ".$offset." ROWS FETCH NEXT ".$data_Rows_Per_Page." ROWS ONLY";
